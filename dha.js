...
petik = '```'
fake = 'CREATOR BOT\©Aryagilang'//GANTI NAMA KAMU BEP
ban =[]
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya Ag-Botz,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©Aryagilang`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`MAU PAKAI SC INI HUBUNGIN ARYAGILANG WA 6289678391870\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Hai kak.....\n*${pushname}*\nJangan Lupa Follow ig ownerku Yahh`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
